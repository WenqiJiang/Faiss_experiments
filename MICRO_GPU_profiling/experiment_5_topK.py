...
Example Usage:
    python experiment_2_algorithm_settings.py --dbname SIFT100M  --index_key OPQ16,IVF8192,PQ16 --nprobe 16 --ngpu 1 --startgpu 0 --qbs 10000 --nsys_enable 1
"""
...
parser.add_argument('--nprobe', type=int, default=1, help="nprobe")
