...
for qbs in qbs_list:
    ...
    for nprobe in nprobe_list:
        ...
        latency_50 = sorted_t_query_list[np.amin([len(sorted_t_query_list), int(np.ceil(len(sorted_t_query_list) * 0.5))])]
        latency_95 = sorted_t_query_list[np.amin([len(sorted_t_query_list), int(np.ceil(len(sorted_t_query_list) * 0.95))])]
