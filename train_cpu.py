...
if FLAGS.index == "IMI":
    ...
    if FLAGS.OPQ:
        for i in IVF_range:
            os.system("python bench_polysemous_1bn.py {} OPQ{},IVF{},PQ{} nprobe=1 >> train_cpu.log".format(
                    FLAGS.dataset, FLAGS.PQ, 2 ** i, FLAGS.PQ))
    else:
        for i in IVF_range:
            os.system("python bench_polysemous_1bn.py {} IVF{},PQ{} nprobe=1 >> train_cpu.log".format(
